...
Deployment : A suitable container will be launched automatically & the code will be auto deployed. Ex- If the code is in php, the program will auto detect and launch a php container and deploy the code.
